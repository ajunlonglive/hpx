...
void test_stop_token_api()
{
    ...
    {
        hpx::experimental::in_place_stop_source* isp =
            new hpx::experimental::in_place_stop_source;
        hpx::experimental::in_place_stop_source& isr = *isp;
        hpx::experimental::in_place_stop_token it{isr.get_token()};
...
void test_stoken(D duration)
{
    ...
    try
    {
        ...
        hpx::experimental::in_place_stop_token it0;
